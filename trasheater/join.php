    ...
    <body>
        ...
        <div id = "container">
            ...
            <form name="frm" action="join.php" method="POST">
                <p><img id="nick-text" src="./nick-text.gif"><input id="nick-input" type="text" name="nickname" placeholder="닉네임" required>
                </p>
                <p><img id="id-text" src="./id-text.gif"><input id="id-input" type="text" name="username" placeholder="사용자이름" required>   
                </p>
                <p><img id="pw-text" src="./pw-text.gif"><input id="pw-input" type="password" name="password" placeholder="비밀번호" required></p>
                ...
                <p><label for="join"><img id = "joinbtn" alt="join" src="./join.png"></label>
