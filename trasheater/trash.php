...
<body>
    <nav>
        <img id= "back" alt="back" src="./back.png" onclick="back()">
    </nav>
    <div id = "container">
        <img id = "title" src="./trash-title.png"><br>
        <img id = "sub_container">
            <label id = "input-image-label" for="input-image"><img id = "upload-img" src="./eat.png" alt="eat"></label>
            <input type="file" id="input-image" accept="image/*" capture="camera" style="display: none;" onclick="readImage(this)">
            <div id="image-container"><img id="image" src="./cha.gif"></div>
            <div id="label-container"></div>
            <h3 id = "cur_point">현재 포인트 : 0pt</h3><img src="./earn.gif" alt = "send"id ="send" onclick="send()">
