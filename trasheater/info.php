...
<body>
<img id = "logout" src="./logout.png" alt="logout" onclick="logout()">
    <div id="container">
        <img src="./info-title.png" id = "title"><br>
        <?php
            echo "<B id = \"info\">닉네임 : {$nickname} | 포인트 : {$pointsum}pt</B><br>";
            if($monster == 1){
                echo "<p><img id = \"character\" src=\"./monster1.gif\" alt=\"슬라임\"></p>";
            }
            elseif($monster == 2){
                echo "<p><img id = \"character\" src=\"./monster2.gif\" alt=\"고래\"></p>";
            }
            elseif($monster == 3){
                echo "<p><img id = \"character\" src=\"./monster3.gif\" alt=\"불\"></p>";
            }
        ?>
                <!-- Go to www.addthis.com/dashboard to customize your tools -->
                <div class="addthis_inline_share_toolbox"></div>
            
        <p><img id = "eat" src="./eat.png" alt="eat" onclick="eat()"></p>
    </div>
    <script>
        const eat = () => {
